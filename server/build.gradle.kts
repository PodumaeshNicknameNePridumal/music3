...
dependencies {
    ...
    implementation(project(":caching-backend"))
    ...
    implementation("io.ktor:ktor-server-content-negotiation:${Versions.Ktor.GENERAL}")
    ...
    implementation("io.ktor:ktor-server-call-logging:${Versions.Ktor.GENERAL}")
